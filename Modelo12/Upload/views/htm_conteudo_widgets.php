...
<div id="section-caracteristicas-<?=$conteudo_id?>" class="container-fluid animate-effect $classes_css" style="padding-top:20px; padding-bottom:-0px; background-color: <?=$cores[58]?>; "> 
	...
	<?php if($conteudo_config->mostrar_titulo == 1){ ?>
		...
		<div class='row' >
			<div class='col-xs-12 col-sm-12 col-md-12' >
				<div>
					<h2 class="titulo_padrao" style="color:<?=$cores[59]?> !important; border-color:<?=$cores[59]?> !important;padding-top:20px " ><?=$conteudo_config->titulo?></h2>
