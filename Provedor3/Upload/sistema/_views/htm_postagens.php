							...
							<div class="box">
								<div class="box-body">
									...
									<div style="text-align:left;">
										...
										<button type="button" class="btn btn-primary" onClick="window.location='<?=$_base['objeto']?>nova/categoria/<?=$categoria_selecionada?>';">Nova</button>
										...
										<button type="button" class="btn btn-default" onClick="window.location='<?=$_base['objeto']?>grupos';">Páginas/Destaques</button>
										
										<button type="button" class="btn btn-default" onClick="window.location='<?=$_base['objeto']?>pg_detalhes';">Página Leitura</button>
										
									</div>

									<div style="text-align:left; padding-top:15px;">
										<label>Categoria <?=ajuda('Selecione a categoria para filtrar as postagens')?></label>
										<select class="form-control select2" name="categoria" onChange="window.location='<?=$_base['objeto']?>inicial/categoria/'+this.value;"; >
