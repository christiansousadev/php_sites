...
<head>
  ...
  <title>Busca - <?=$_base['titulo_pagina']?></title>
              ...
              <div id="conteudo" style="padding-top: 80px;">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-8" >
                    ...
                    <div class="titulo_padrao" >Resultados da Busca</div>
                    
                    <div style="margin-top:80px; padding-bottom: 80px; text-align: center;">
                      <?php

                      $n = 0;
                      foreach ($lista as $key => $value) {
                        
                        echo "<div style='text-align:center; padding-top:20px;'><a href='".$value['link']."' style='font-size:16px; color:#000;'>".$value['titulo']."</a></div>";
