                  ...
                  <form action="<?=$_base['objeto']?>alterar_grv" class="form-horizontal" method="post">  						
                    ...
                    <fieldset> 
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-7">
                          <input name="valor" type="text" class="form-control" value="<?=$data->valor?>" onkeypress="Mascara(this,Integer)" onKeyDown="Mascara(this,Integer)" >
                        </div>
                      </div>
                ...
                <div id="imagem" class="tab-pane <?php if($aba_selecionada == "imagem"){ echo "active"; } ?>" >
                  ...
                  <?php } else { ?>
                    ...
                    <div style="text-align:left;">
                      <img src="<?=PASTA_CLIENTE?>img_contador/<?=$data->imagem?>" style="max-width:300px;" >
                    </div>
