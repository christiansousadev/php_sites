...
<div id="section-videos-<?=$conteudo_id?>" class="container-fluid animate-effect" style="padding-top:50px; padding-bottom:80px; background-color: <?=$cores[56]?>; "> 
		...
		<div class='row' >
			<div class='col-xs-12 col-sm-12 col-md-12' >
				<div>
					...
					<div class="titulo_padrao_linha" style="color:<?=$cores[57]?>; " ></div> 
				</div>
			</div>
		</div>
	...
	if($conteudo_config->mostrar_categorias == 0){
		...
		foreach ($lista as $key => $value) {
			...
			echo " 
			<div class='videos_div $classes_css' >
			";
		...
		<div class="row">
			...
			<div style="margin-top: 30px; background-color:<?=$cores['95']?>; padding-left:20px; padding-right: 20px; padding-bottom: 20px; padding-top: 10px; <?php if($conteudo_config->tipo_menu == 1){ echo "text-align:center;";  } ?> ">
				<?php
