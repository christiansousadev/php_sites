...
<head>
  ...
  <title>Marcas - <?=$_base['titulo_pagina']?></title>
            ...
            <div class="contentarea"> 
              ...
              <div id="conteudo" style="padding-top:0px;">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12" >
                    <div class="titulo_padrao" >Marcas e Produtos<br><i></i></div>
                  </div>

                  <div class="row">
                    <div class="col-sm-12" >

                      <div style="padding-top:30px; margin-bottom: 80px; text-align: center;">
                        <?php

                        foreach ($marcas as $key => $value) {

                          echo "
                          <div class='marcas_item' style='background-image:url(".$value['imagem'].");' ></div>";
