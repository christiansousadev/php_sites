    	...
    	<div class="row">        	
        	...
        	<div class="nav-tabs-custom">
                ...
                <div class="form-group">
  								...
  								<div class="col-md-6">
  									<input name="titulo" type="text" class="form-control" value="<?=$data->titulo?>" <?php if(!$acesso_alterar_titulo){ echo "disabled"; } ?> >
  								</div>
  							</div>
                
                <div class="form-group">
                  <label class="col-md-12" >Nome para a url (deve ser único, sem caracteres especiais ou acentos e separados por '-' ex: 'nova-pagina-criada)'</label>
                  <div class="col-md-12">
