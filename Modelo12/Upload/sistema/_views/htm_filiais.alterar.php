            ...
            <li <?php if($aba_selecionada == "imagem"){ echo "class='active'"; } ?> onClick="carrega_envio_imagens();" >
              <a href="#imagem" data-toggle="tab">Imagens</a>
                ...
                <div class="form-group">
  								<label class="col-md-12" >Titulo/nome</label>
  								<div class="col-md-6">
                ...
                <div class="form-group">
                  <label class="col-md-12">Descrição <?=ajuda('Na descrição é possivel adicionar trechos em html e também imagens, porem é recomendado deixar as imagens para a próxima etapa.')?></label>
                  <div class="col-md-12">
                  ...
                  foreach ($imagens as $key => $value) {
                    ...
                    <li id='item_".$value['id']."' >
                      ...
                      <div style='padding-top:5px; text-align:center;'>
                        <button class='btn btn-default fa fa-align-center' onClick=\"modal('".$_base['objeto']."legenda/id/".$value['id']."/codigo/$data->codigo', 'Alterar Legenda');\" title='Editar legenda' ></button>
