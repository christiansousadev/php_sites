...
<form action="<?=$_base['objeto']?>grupos_alterar_grv" class="form-horizontal" method="post" >
	...
	<fieldset>
		...
		<div class="form-group">
			...
			<div class="col-md-12">
				<select name="itens_por_linha" class="form-control select2" style="width: 100%;" >
					...
					<option value='6' <?php if($data->itens_por_linha == 6){ echo " selected='' "; } ?> >6</option>
				</select>
			</div>
		</div>
		...
		<div class="form-group">
			<label class="col-md-12" >Mostrar titulo do plano</label>
			<div class="col-md-12">
				<select name="plano_titulo" class="form-control select2" style="width: 100%;" >
					<option value='1' <?php if($data->plano_titulo == 1){ echo " selected='' "; } ?> >Sim</option>
					<option value='0' <?php if($data->plano_titulo == 0){ echo " selected='' "; } ?> >Não</option> 
				</select>
			</div>
		</div>

		<div class="form-group">
			<label class="col-md-12" >Mostrar itens do plano</label>
			<div class="col-md-12">
				<select name="plano_itens" class="form-control select2" style="width: 100%;" >
					<option value='1' <?php if($data->plano_itens == 1){ echo " selected='' "; } ?> >Sim</option>
					<option value='0' <?php if($data->plano_itens == 0){ echo " selected='' "; } ?> >Não</option> 
				</select>
			</div>
		</div>

		<div class="form-group">
			<label class="col-md-12" >Mostrar valor do plano</label>
			<div class="col-md-12">
				<select name="plano_valor" class="form-control select2" style="width: 100%;" >
					<option value='1' <?php if($data->plano_valor == 1){ echo " selected='' "; } ?> >Sim</option>
					<option value='0' <?php if($data->plano_valor == 0){ echo " selected='' "; } ?> >Não</option> 
				</select>
			</div>
		</div>
