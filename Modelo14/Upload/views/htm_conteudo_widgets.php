...
<div id="section-caracteristicas-<?=$conteudo_id?>" class="container-fluid animate-effect $classes_css" style="padding-top:-10px; padding-bottom:-10px; background-color: <?=$cores[58]?>; "> 
