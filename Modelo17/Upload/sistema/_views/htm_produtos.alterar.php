                  ...
                  <fieldset>
                    ...
                    <div class="row" >
                        ...
                        <div class="col-md-3">
                          ...
                          <div style="padding-top:10px; padding-bottom:20px;"><strong>CORES</strong></div>
                          ...
                          <div class="form-group">
                            <div class="col-md-12">
                              ...
                              foreach ($lista_cores as $key => $value) {
                                ...
                                <input type='checkbox' id='cor_".$value['id']."' name='cor_".$value['id']."' $check value='1' >
                                <label for='cor_".$value['id']."' >".$value['titulo']."</label>
                                </div>
                                ";
                        ...
                        <div class="col-md-3">
                          ...
                          <div style="padding-top:10px; padding-bottom:20px;"><strong>TECIDOS</strong></div>
                          ...
                          <div class="form-group">
                            <div class="col-md-12">
                              ...
                              foreach ($lista_tecidos as $key => $value) {
                                ...
                                echo "
                                <div class='checkbox-custom' >
                                <input type='checkbox' id='tecido_".$value['id']."' name='tecido_".$value['id']."' $check value='1' >
                                <label for='tecido_".$value['id']."' >".$value['titulo']."</label>
                                </div>
                                ";
                        ...
                        <div class="col-md-3">
                          ...
                          <div style="padding-top:10px; padding-bottom:20px;"><strong>TAMANHOS</strong></div>
                          ...
                          <div class="form-group">
                            <div class="col-md-12">
                              ...
                              foreach ($lista_tamanhos as $key => $value) {
                                ...
                                echo "
                                <div class='checkbox-custom' >
                                <input type='checkbox' id='tamanho_".$value['id']."' name='tamanho_".$value['id']."' $check value='1' >
                                <label for='tamanho_".$value['id']."' >".$value['titulo']."</label>
                                </div>
                                ";
                        ...
                        <div class="col-md-3">
                          ...
                          <div style="padding-top:10px; padding-bottom:20px;"><strong>PERSONALIZAÇÕES</strong></div>
                          ...
                          <div class="form-group">
                            <div class="col-md-12">
                              ...
                              foreach ($lista_personalizacoes as $key => $value) {
                                ...
                                echo "
                                <div class='checkbox-custom' >
                                <input type='checkbox' id='personalizacao_".$value['id']."' name='personalizacao_".$value['id']."' $check value='1' >
                                <label for='personalizacao_".$value['id']."' >".$value['titulo']."</label>
                                </div>
                                ";
