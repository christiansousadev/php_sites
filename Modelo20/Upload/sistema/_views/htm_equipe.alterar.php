          ...
          <div class="col-xs-12">
            ...
            <div class="nav-tabs-custom">
              ...
              <ul class="nav nav-tabs">
                ...
                <li <?php if($aba_selecionada == "links"){ echo "class='active'"; } ?> >
              ...
              <div class="tab-content" >
                ...
                <div id="links" class="tab-pane <?php if($aba_selecionada == "links"){ echo "active"; } ?>" >

                  <div>
                    <button type="button" class="btn btn-primary" onClick="modal('<?=$_base['objeto']?>links_novo/codigo/<?=$data->codigo?>', 'Novo');" >Novo</button>
                  </div>
                  ...
                  <div>
                    <table class="table table-bordered table-striped">
                      ...
                      <tbody>
                        ...
                        foreach ($lista_links as $key => $value) {

                          echo "
                          <tr>
                          <td style='width:30px;' >
                          <a href='#' onclick=\"confirma('".DOMINIO."equipe/links_apagar/id/".$value['id']."')\" >Apagar</a>
                          </td>
                          <td>".$value['titulo']."</td>
                          <td>".$value['link']."</td>
                          </tr>
