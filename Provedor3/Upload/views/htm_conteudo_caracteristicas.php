...
<div id="section-caracteristicas-<?=$conteudo_id?>" class="container-fluid animate-effect" style="padding-top:50px; padding-bottom:20px; background-color: <?=$cores[22]?>; ">
	...
	<?php if($conteudo_config->descricao){ ?>
		...
		<div class='row' >
			<div class='col-xs-12 col-sm-12 col-md-12' >
				<div style="margin-top:-70px; padding-bottom: 20px; font-size: 16px; color:<?=$cores[23]?>; text-align: center;">
