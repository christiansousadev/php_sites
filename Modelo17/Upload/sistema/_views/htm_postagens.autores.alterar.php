      ...
      <!-- Main content -->
    	...
    	<div class="row">        	
            ...
            <li <?php if($aba_selecionada == "imagem"){ echo "class='active'"; } ?> >
              <a href="#imagem" data-toggle="tab">Imagem</a>
  				...
  				<div class="tab-content" >
  					...
  					<form action="<?=$_base['objeto']?>alterar_autor_grv" class="form-horizontal" method="post">  						
              ...
              <div>
                ...
                <button type="button" class="btn btn-default" onClick="window.location='<?=$_base['objeto']?>autores';" >Voltar</button>
  						</div>
            ...
            <div id="imagem" class="tab-pane <?php if($aba_selecionada == "imagem"){ echo "active"; } ?>" >
              <?php if(!$data->imagem){ ?>
              <form action="<?=$_base['objeto']?>alterar_autor_imagem/codigo/<?=$data->codigo?>" method="post" enctype="multipart/form-data">
              ...
              <?php } else { ?>
                ...
                <div style="text-align:left; padding-top:10px;">
                  <button type="button" class="btn btn-primary" onClick="confirma('<?=$_base['objeto']?>apagar_autor_imagem/codigo/<?=$data->codigo?>');" >Apagar Imagem</button>
                  <button type="button" class="btn btn-default" onClick="window.location='<?=$_base['objeto']?>autores';" >Voltar</button>
                </div>
