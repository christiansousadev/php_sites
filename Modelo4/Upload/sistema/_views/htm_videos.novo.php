            ...
            <div class="tab-content" >
             ...
             <div id="dados" class="tab-pane <?php if($aba_selecionada == "dados"){ echo "active"; } ?>" >
               <form action="<?=$_base['objeto']?>novo_grv" class="form-horizontal" method="post">
                ...
                <div class="form-group">
                  <label class="col-md-12">Prévia <?=ajuda('A prévia é o resumo do vídeo é importante para fins de SEO.')?></label>
                  <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-12">
                    <textarea name="conteudo" class="form-control" style="height: 100px;" ></textarea>
                  </div>
                </div>
              ...
              <div>
                ...
                <button type="button" class="btn btn-default" onClick="window.location='<?=$_base['objeto']?>inicial/categoria/<?=$categoria_selecionada?>';" >Voltar</button>
              </div>
