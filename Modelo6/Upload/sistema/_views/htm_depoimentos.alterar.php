            ...
            <form action="<?=$_base['objeto']?>alterar_grv" class="form-horizontal" method="post">
              ...
              <div class="panel-body">
               ...
               <div class="form-group">
                ...
                <div class="col-md-6">
                  <input name="empresa" type="text" class="form-control" value="<?=$data->empresa?>" >
                </div>
              </div>
              ...
              <div class="form-group">
                <label class="col-md-12">Status <?=ajuda('Use o status para esconder ou mostrar o depoimento no site.')?></label>
                <div class="col-md-6">
