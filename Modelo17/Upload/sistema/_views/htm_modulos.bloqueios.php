...
<div class="wrapper">
	...
	<section class="panel">
	<form action="<?=$_base['objeto']?>bloqueios_grv" class="form-horizontal" method="post">    	
        
        <div class="panel-body">
        	
        	<div style="font-size:14px; padding-bottom:20px;">Marque os módulos que estarão disponíveis no sistema:</div>
