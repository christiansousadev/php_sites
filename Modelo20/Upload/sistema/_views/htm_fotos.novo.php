          ...
          <div class="tab-content" >
           ...
           <div id="dados" class="tab-pane <?php if($aba_selecionada == "dados"){ echo "active"; } ?>" >
             <form action="<?=$_base['objeto']?>novo_grv" class="form-horizontal" method="post">
              ...
              <div class="form-group">
                <label class="col-md-12">Prévia <?=ajuda('A prévia é o resumo do album.')?></label>
                <div class="col-md-6">
              ...
              <div class="form-group">
                <label class="col-md-12">Conteúdo <?=ajuda('No conteudo do album é possivel adicionar uma descrição, trechos em html e também imagens, porem é recomendado deixar as imagens para a próxima etapa.')?></label>
                <div class="col-md-12">
            ...
            <div>
              ...
              <button type="button" class="btn btn-default" onClick="window.location='<?=$_base['objeto']?>inicial/categoria/<?=$categoria?>';" >Voltar</button>
            </div>
