							...
							<div class="box">
								<div class="box-body">
									...
									<div style="text-align:left;">
										...
										<button type="button" class="btn btn-default" onClick="window.location='<?=$_base['objeto']?>combustivel';">Combustivel</button>
										
										<button type="button" class="btn btn-default" onClick="window.location='<?=$_base['objeto']?>cores';">Cores</button>
										
										<button type="button" class="btn btn-default" onClick="window.location='<?=$_base['objeto']?>transmissao';">Transmissão</button>
										
										<button type="button" class="btn btn-default" onClick="window.location='<?=$_base['objeto']?>motor';">Motor</button>
										
										<button type="button" class="btn btn-default" onClick="window.location='<?=$_base['objeto']?>opcionais';">Opcionais</button>
									...
									<table id="tabela1" class="table table-bordered table-striped">
										...
										<tbody>
											...
											foreach ($lista as $key => $value) {
												...
												<td $linklinha >".$value['ref']."</td>
												<td $linklinha >".$value['titulo']."</td>
												<td $linklinha ><span style='text-transform:capitalize;'>".$value['tipo']."</span></td>
												</tr>
												";
