								...
								<div id="imagem" class="tab-pane <?php if($aba_selecionada == "imagem"){ echo "active"; } ?>" >
									...
									<div class="row" >
										...
										<div class="col-xs-6">
											...
											<h4>Imagens Secundárias</h4>

											<div>
												<form action="<?=$_base['objeto']?>imagem2/codigo/<?=$data->codigo?>" method="post" enctype="multipart/form-data">
											...
											foreach ($sub_imagens as $key => $value) {
												...
												echo "
												<div style='display:inline-block; width:150px; margin:10px; text-align:center;'>
													<div style='width:100%; height:100px; overflow:hidden; '>
														<img src='".PASTA_CLIENTE."imagens/".$value['imagem']."' style='width:100%;'>
													</div>
													<div style='margin-top:5px;'>
														<button type='button' class='btn btn-primary' onClick=\"confirma('".$_base['objeto']."apagar_imagem2/codigo/".$data->codigo."/id/".$value['id']."');\" >Apagar</button>
													</div>
												</div>
												";
