...
<div id="section-caracteristicas-<?=$conteudo_id?>" class="container-fluid animate-effect $classes_css" style="padding-top:0px; padding-bottom:0px; background-color: <?=$cores[58]?>; "> 
