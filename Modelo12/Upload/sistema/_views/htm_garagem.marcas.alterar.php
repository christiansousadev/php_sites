     ...
     <section class="content">
       <div class="row">        	
         <div class="col-xs-12">
          ...
          <div class="tab-content" >
           ...
           <div id="dados" class="tab-pane <?php if($aba_selecionada == "dados"){ echo "active"; } ?>" >
             <form action="<?=$_base['objeto']?>marcas_alterar_grv" class="form-horizontal" method="post">  						
            ...
            <div>
              ...
              <button type="button" class="btn btn-default" onClick="window.location='<?=$_base['objeto']?>marcas';" >Voltar</button>
            </div>
        ...
        <div id="imagem" class="tab-pane <?php if($aba_selecionada == "imagem"){ echo "active"; } ?>" >
          <?php if(!$data->imagem){ ?>
            <form action="<?=$_base['objeto']?>marcas_imagem/codigo/<?=$data->codigo?>" method="post" enctype="multipart/form-data">
          ...
          <?php } else { ?>
            ...
            <div style="text-align:left;">
              <img src="<?=PASTA_CLIENTE?>img_marcas/<?=$data->imagem?>" style="max-width:300px;" >
            </div>

            <div style="text-align:left; padding-top:10px;">
              <button type="button" class="btn btn-primary" onClick="confirma('<?=$_base['objeto']?>marcas_apagar_imagem/codigo/<?=$data->codigo?>');" >Apagar Imagem</button>
              <button type="button" class="btn btn-default" onClick="window.location='<?=$_base['objeto']?>marcas';" >Voltar</button>
            </div>
