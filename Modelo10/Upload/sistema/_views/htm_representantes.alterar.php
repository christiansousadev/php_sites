	...
	<div class="content-wrapper">
    	...
    	<div class="row">        	
        	...
        	<div class="nav-tabs-custom">
                  ...
                  <div class="col-md-6">
                    ...
                    <?php
                      foreach ($estados as $key => $value) {
                        ...
                        echo "<option value='".$value['uf']."' ".$value['selected']." >".$value['nome']."</option>";
                ...
                <div class="form-group">
  								<label class="col-md-12" >Contato</label>
  								<div class="col-md-6">
  									<input name="contato" type="text" class="form-control" value="<?=$data->contato?>" >
  								</div>
  							</div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <input name="regiao" type="text" class="form-control" value="<?=$data->regiao?>" >
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <input name="fone" type="text" class="form-control" onkeypress="Mascara(this,telefone)" onKeyDown="Mascara(this,telefone)" maxlength="15" value="<?=$data->fone?>" >
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <input name="celular" type="text" class="form-control" onkeypress="Mascara(this,telefone)" onKeyDown="Mascara(this,telefone)" maxlength="15" value="<?=$data->celular?>" >
                  </div>
                </div>
