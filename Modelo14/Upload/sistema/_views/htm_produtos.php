							...
							<div class="box">
								<div class="box-body">
									...
									<div style="text-align:left;">
										...
										<button type="button" class="btn btn-primary" onClick="modal('<?=$_base['objeto']?>novo', 'Novo Produto');">Novo Produto</button>
									...
									<table id="tabela1" class="table table-bordered table-striped">
										...
										<tbody>
											...
											foreach ($lista as $key => $value) {
												...
												$linklinha = "onClick=\"window.location='".$_base['objeto']."alterar_produto/codigo/".$value['codigo']."';\" style='cursor:pointer;' ";
												
												echo "
												<tr>
												<td class='center' style='width:30px;' ><input type='checkbox' class='marcar' name='apagar_".$value['id']."' value='1' ></td>
												<td><a href='".$_base['objeto']."alterar_produto/codigo/".$value['codigo']."' >".$value['ref']."</a></td>
												<td $linklinha >".$value['titulo']."</td> 
												<td $linklinha >".$value['estoque']."</td>
												<td $linklinha >".$value['digital']."</td>
												</tr>
												";
