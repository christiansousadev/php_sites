...
<body>
	...
	<div id="modal_janela_pg" class="modal fade" role="dialog">
		<div class="modal-dialog">
			<div id="fecharmodal" style="position: absolute; z-index: 999; top:-10px; right:-7px; font-size: 26px; cursor: pointer;" onclick="fecharmodaljanela_pg();" ><i class="fas fa-times-circle"></i></div>
			<div class="modal-content">
				<div class="modal-body">
					<div style="padding:15px; text-align: center;" >
						
						<form id='envairpgmp' name='envairpgmp' method='POST'>
							<script src='https://www.mercadopago.com.br/integrations/v1/web-payment-checkout.js' data-preference-id='<?=$abre_pagamento?>' ></script>
						</form>
						
						<div style='font-size: 14px; margin-top: 10px;'>Caso já tenha efetuado o pagamento aguarde a compensação.</div>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12">
					<h2 class="titulo_padrao" ><i class="fa fa-users" aria-hidden="true"></i> MINHA CONTA</span></h2>
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-5 col-md-5">
					<div class="nome_cliente">Olá <i class="fa fa-arrow-right" aria-hidden="true"></i> <?=$nome_do_usuario?></div>
				</div>

				<div class="col-xs-12 col-sm-7 col-md-7">
					<div class="bt_alterar_dados">

						<button type="button" class="botao_padrao <?=$botao_css?>"  onClick="modal('<?=DOMINIO?><?=$controller?>/imoveis_comprar_plano');" ><i class="fa fa-shopping-cart" aria-hidden="true"></i> PLANOS</button>

						<button type="button" class="botao_padrao <?=$botao_css?>"  onClick="window.location='<?=DOMINIO?><?=$controller?>/adicionar_imovel';" ><i class="fa fa-home" aria-hidden="true"></i> ADICIONAR IMÓVEL</button>

						<button type="button" class="botao_padrao <?=$botao_css?>"   onClick="window.location='<?=DOMINIO?><?=$controller?>/alterar_cadastro';" ><i class="fa fa-cog" aria-hidden="true"></i> ALTERAR DADOS</button>

						<button type="button" onClick="window.location='<?=DOMINIO?><?=$controller?>/logout'"; class="botao_padrao <?=$botao_css?>" ><i class="fa fa-times-circle" aria-hidden="true"></i> SAIR</button>
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-12 col-md-12" >
					...
					<div style="font-size:19px; font-weight:bold; margin-bottom:20px; margin-top: 20px; ">MEUS IMÓVEIS</div>
					
					<div class="pedidostabela" style="min-height:50px;">
						<div class="table-responsive">
							<table class="table tabela_pedidos">
								
								<thead>
									<tr>
										<th><i class="fa fa-barcode" aria-hidden="true"></i> Ref.</th>
										<th><i class="fa fa-cube" aria-hidden="true"></i> Titulo</th>
										<th><i class="fa fa-calendar" aria-hidden="true"></i> Vencimento</th> 
										<th><i class="fa fa-star" aria-hidden="true"></i> Status</th> 
									</tr>
								</thead>
								...
								foreach ($lista_imoveis as $key => $value) {
									...
									$endereco = DOMINIO.$controller."/alterar_imovel/id/".$value['codigo'];

									if($value['vencimento'] <= time()){
										$status = "<span style='cursor:pointer; font-size:15px; font-weight:bold; color:#000;' onClick=\"modal('".DOMINIO.$controller."/imoveis_ativar_anuncio/codigo/".$value['codigo']."');\" >Ativar</span>";
										$vencimento = '-';
									} else {
										$status = "OK";
										$vencimento = date('d/m/Y', $value['vencimento']);
									}
									
									echo "
									<tr>
									<td><a href='$endereco' >".$value['id']."</a></td>
									<td><a href='$endereco' >".$value['titulo']."</a></td>
									<td><a href='#' >".$vencimento."</a></td>
									<td>".$status."</td>
									</tr>
									";
								...
								if($n == 0){
									echo "
									<tr>
									<td colspan='4' style='text-align:center; padding:30px;' > OPS! NÃO HÁ IMÓVEIS CADASTRADOS </td> 
									</tr>
									";
								}
					...
					<div style="width: 100%; padding-top:30px;"><hr></div>
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-12 col-md-12" >
					...
					<div style="font-size:19px; font-weight:bold; margin-bottom:20px; margin-top: 20px; ">PLANOS CONTRATADOS</div>
							...
							<table class="table tabela_pedidos">
								...
								foreach ($lista_pedidos as $key => $value) {
									...
									if($value['status_id'] == 1){
										$endereco = "href='".DOMINIO.$controller."/imoveis_cliente/pagamento/".$value['codigo']."' ";
									} else { 
										$endereco = "href='#' onClick=\"modal('".DOMINIO.$controller."/imoveis_pedido_detalhes/codigo/".$value['codigo']."')\" ";
									}
									
									echo "
									<tr>
									<td><a $endereco >".$value['id']."</a></td>
									<td><a $endereco >".$value['plano']."</a></td>
									<td><a $endereco >".$value['anuncios']."</a></td>
									<td><a $endereco >".$value['status']."</a></td>
									</tr>
									";
								...
								if($n == 0){
									echo "
									<tr>
									<td colspan='4' style='text-align:center; padding:30px;' >CONTRATE UM PLANO DE ANUNCIO</td> 
									</tr>
									";
								}
	...
	<script>
		...
		if($abre_pagamento){
			?>
			function abrepg(){
				$('#modal_janela_pg').modal('show'); 
			}
			abrepg();

			function fecharmodaljanela_pg(){ 
				$('#modal_janela_pg').modal('hide'); 
			}
			<?php
		}
		?>
