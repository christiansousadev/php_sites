							...
							<div class="box">
								<div class="box-body">
									...
									<div style="text-align:left;">
										...
										<button type="button" class="btn btn-default" onClick="modal('<?=$_base['objeto']?>gratis', 'Novo');">Plano Gratuito</button>
									...
									<table id="tabela1" class="table table-bordered table-striped">
										...
										<tbody>
											...
											foreach ($lista as $key => $value) {
												...
												<td $linklinha >".$value['meses']."</td>
												<td $linklinha >".$value['dias']."</td>
												<td $linklinha >".$value['limite']."</td>
