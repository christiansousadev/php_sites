			...
			<form action="<?=$_base['objeto']?>grupos_alterar_grv" class="form-horizontal" method="post" >
				...
				<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-md-12">
							<select name="novo_usado" class="form-control select2" style="width: 100%;" >
								<option value='novo' <?php if($data->novo_usado == 'novo'){ echo " selected='' "; } ?> >Novos</option>
								<option value='usado' <?php if($data->novo_usado == 'usado'){ echo " selected='' "; } ?> >Usados</option> 
							</select>
						</div>
					</div>
		...
		<div id="imagem" class="tab-pane" >			 
			...
			<div style="text-align:center;">
				...
				foreach ($imagens as $key => $value) {
					...
					<div class='quadro_img' style='cursor:auto; background-image:url(".PASTA_CLIENTE.'img_garagem_grupos/'.$value['imagem']."); '></div>
