...
class postagens extends controller {
	...
	public function inicial(){
		...
		if($this->nivel_acesso(30, false)){
			$dados['acesso_mascara'] = true;
		} else {
			$dados['acesso_mascara'] = false;
		}

		if($this->nivel_acesso(34, false)){
			$dados['acesso_destaques'] = true;
		} else {
			$dados['acesso_destaques'] = false;
		}

		if($this->nivel_acesso(35, false)){
			$dados['acesso_categorias'] = true;
		} else {
			$dados['acesso_categorias'] = false;
		}

		if($this->nivel_acesso(58, false)){
			$dados['acesso_autores'] = true;
		} else {
			$dados['acesso_autores'] = false;
		}
