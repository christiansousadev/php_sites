...
<form id="form_depoimento" name="form_depoimento" method="post" action="<?=DOMINIO?><?=$controller?>/enviar_depoimento" method="post" >
	...
	<div class="row" >
		...
		<div class="form-group col-md-12">
			<div class="botao_contato" >
				<input type="submit" class="btn btn-default add-to-cart hvr-float-shadow" style="padding-top:10px; background-color: #000; color:#fff;" value="ENVIAR" >
			</div>
		</div>
