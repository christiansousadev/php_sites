		...
		<div class="content-wrapper">
			...
			<section class="content">
				<div class="row">
					...
					<div class="col-xs-12">    		
						<form action="<?=$_base['objeto']?>modelos_apagar" method="post" id="form_apagar" name="form_apagar" >
									...
									<table id="tabela1" class="table table-bordered table-striped">
										...
										<tbody>
											...
											foreach ($lista as $key => $value) {
												...
												$linklinha = "onClick=\"modal('".$_base['objeto']."modelos_alterar/codigo/".$value['codigo']."', 'Alterar');\" style='cursor:pointer;' ";
												
												echo "
												<tr>
												<td style='width:30px;' ><input type='checkbox' class='marcar' name='apagar_".$value['id']."' value='1' ></td>
												<td $linklinha >".$value['titulo']."</td>
												<td $linklinha >".$value['marca']."</td>
												</tr>
												";
