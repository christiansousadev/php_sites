				...
				<div class="box">
					<div class="box-body">
						...
						<div>
							...
							<button type="button" class="btn btn-primary" onClick="modal('<?=$_base['objeto']?>novo', 'Enviar Arquivo');">Novo</button>
						...
						<table id="tabela1" class="table table-bordered table-striped">
							...
							<?php
								...
								foreach ($lista as $key => $value) {
									...
									$linklinha = "onClick=\"window.open('".PASTA_CLIENTE."arquivos/".$value['arquivo']."', '_blank');\" style='cursor:pointer;' ";
									...
									<tr>
										...
										<td $linklinha >".$value['usuario']."</td>
										<td $linklinha >".$value['titulo']."</td>
										<td $linklinha >".$value['arquivo']."</td>
									</tr>
									";
								}
