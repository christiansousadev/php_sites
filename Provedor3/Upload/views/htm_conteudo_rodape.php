			...
			<div class="container">
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12" >					
						<a href="https://www.m2sites.com.br" target="_blank" ><?=$conteudo_sessao['data_rodape']->copy?></a>
					</div>
				</div>
			</div>
		</div>
	...
	<footer class="rodape" >
		...
		<div class="rodape_copy" >
			<div class="container">
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12" >					
						<a href="https://www.seusite.com.br" target="_blank" ><?=$conteudo_sessao['data_rodape']->copy?></a>
					</div>
				</div>
			</div>
		</div>
