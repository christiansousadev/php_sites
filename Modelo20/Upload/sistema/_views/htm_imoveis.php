							...
							<div class="box">
								<div class="box-body">
									...
									<div style="text-align:left;">
										...
										<button type="button" class="btn btn-primary" onClick="modal('<?=$_base['objeto']?>novo', 'Cadastrar');">Cadastrar</button>
										...
										<button type="button" class="btn btn-default" onClick="window.location='<?=$_base['objeto']?>cidades';">Cidades</button>
										
										<button type="button" class="btn btn-default" onClick="window.location='<?=$_base['objeto']?>bairros';">Bairros</button>
										
										<button type="button" class="btn btn-default" onClick="window.location='<?=$_base['objeto']?>tipos';">Tipos</button>
										
										<button type="button" class="btn btn-default" onClick="window.location='<?=$_base['objeto']?>opcoes';">Opções</button>
										...
										<button type="button" class="btn btn-default" onClick="window.location='<?=$_base['objeto']?>pg_detalhes';">Pag. Detalhes</button>
										
										<button type="button" class="btn btn-default" onClick="window.location='<?=$_base['objeto']?>relatorio';">Relatorio</button>
									...
									<table id="tabela1" class="table table-bordered table-striped">
										...
										<tbody>
											...
											foreach ($lista as $key => $value) {
												...
												<td $linklinha >".$value['cod_interno']."</td>
												<td $linklinha >".$value['titulo']."</td>
												<td $linklinha >".$value['categoria_titulo']."</td>
												<td $linklinha >".$value['tipo_titulo']."</td>
