		...
		<div class="content-wrapper">
			...
			<section class="content">
				<div class="row">
					...
					<div class="col-xs-12">    		
						<form action="<?=$_base['objeto']?>cidades_apagar" method="post" id="form_apagar" name="form_apagar" >
							...
							<div class="box">
								<div class="box-body">
									...
									<div style="text-align:left;">
										...
										<button type="button" class="btn btn-primary" onClick="modal('<?=$_base['objeto']?>cidades_nova', 'Nova Cidade');">Nova</button>
										...
										<thead>
											...
											<tbody>
												...
												foreach ($lista as $key => $value) {
													...
													$linklinha = "onClick=\"modal('".$_base['objeto']."cidades_alterar/codigo/".$value['codigo']."', 'Alterar Cidade');\" style='cursor:pointer;' ";
													...
													<td $linklinha >".$value['estado']."</td>
													<td $linklinha >".$value['principal']."</td>
													</tr>
													";
