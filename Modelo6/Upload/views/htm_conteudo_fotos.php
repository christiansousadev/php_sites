...
<section id="section-fotos-<?=$conteudo_id?>" class="animate-effect" style="padding-top:50px; padding-bottom:50px; background-color: <?=$cores['40']?>; ">
	<div class="container">
			...
			<div class='row' >
				<div class='col-xs-12 col-sm-12 col-md-12' >
					<div>
						...
						<div class="titulo_padrao_linha" style="color:<?=$cores[41]?>; " ><i class="fas fa-caret-down"></i></div> 
					</div>
				</div>
			</div>
		...
		if($conteudo_config->mostrar_categorias == 0){
			...
			if($conteudo_config->formato == 'imagens'){
				...
				foreach ($lista as $key => $value) {
					if( ($total_n <= $conteudo_config->max_itens) OR ($conteudo_config->max_itens == 0) ){

						if($n_row == 1){ echo "<div class='row' style='padding-left:15px; padding-right:15px;' >"; }

						if($conteudo_config->itens_por_linha == 1){
							echo "<div class='col-xs-12 col-sm-12 col-md-12' style='padding-left:5px; padding-right:5px;padding-top:5px;' >";
						}
						if($conteudo_config->itens_por_linha == 2){
							echo "<div class='col-xs-12 col-sm-6 col-md-6' style='padding-left:5px; padding-right:5px;padding-top:5px;' >";
						}
						if($conteudo_config->itens_por_linha == 3){
							echo "<div class='col-xs-12 col-sm-4 col-md-4' style='padding-left:5px; padding-right:5px;padding-top:5px;' >";
						}
						if($conteudo_config->itens_por_linha == 4){
							echo "<div class='col-xs-12 col-sm-3 col-md-3' style='padding-left:5px; padding-right:5px;padding-top:5px;' >";
						}
				...
				foreach ($lista as $key => $value) {
					...
					if( ($total_n <= $conteudo_config->max_itens) OR ($conteudo_config->max_itens == 0) ){
						...
						echo " 
						<a class='fotos2_div' style='background-image:url(".$value['imagem'].");' href='".DOMINIO.$controller."/fotos_detalhes/codigo/".$value['codigo']."' ></a>
