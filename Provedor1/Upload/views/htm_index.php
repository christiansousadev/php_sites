      ...
      <div class="container">
        <div class="row">      
          ...
          <div class="col-xs-2 col-sm-2 col-md-2" >
            ...
            <span class='radio_texto'><strong>NO AR</strong></span>
          ...
          <div class="col-xs-10 col-sm-4 col-md-3" >
            ...
            <div class="radio_titulo" style="background-color: <?=$radio_cores->cor_titulo_atual_fundo?>; color: <?=$radio_cores->cor_titulo_atual_texto?>; "><i class="fa fa-music" aria-hidden="true"></i> AGORA</div>
            <div class="radio_atual" >
              <div class='radio_programa' ><?=$programacao_atual['programa']?></div>
              <div class='radio_apresentador' ><?=$programacao_atual['apresentador']?></div>
            </div>
          ...
          <div class="col-xs-12 col-sm-4 col-md-4" id="divradiodepois" >
            <div class="radio_proximo">
              <div class='radio_programa' ></div>
              <div class='radio_apresentador' ></div>
            </div>
