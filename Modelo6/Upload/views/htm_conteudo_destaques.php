...
<section id="section-destaques-<?=$conteudo_id?>" class="animate-effect" style="padding-top:50px; padding-bottom:80px; background-color: <?=$cores[63]?>; ">
	<div class="container">
			...
			<div class='row' >
				<div class='col-xs-12 col-sm-12 col-md-12' >
					<div>
						...
						<div class="titulo_padrao_linha" style="color:<?=$cores[64]?>; " ><i class="fa fa-home"></i></div> 
					</div>
				</div>
			</div>
		...
		foreach ($destaques_lista as $key => $value) {
			...
			if($value['imagem']){
				...
				if($conteudo_config->itens_por_linha == 2){
					echo "<div class='col-xs-12 col-sm-6 col-md-6' style='padding-left:6px !important; padding-right:6px !important; padding-top:6px !important;' >";
				}
				if($conteudo_config->itens_por_linha == 3){
					echo "<div class='col-xs-12 col-sm-4 col-md-4' style='padding-left:6px !important; padding-right:6px !important; padding-top:6px !important;' >";
				}
				if($conteudo_config->itens_por_linha == 4){
					echo "<div class='col-xs-12 col-sm-3 col-md-3' style='padding-left:6px !important; padding-right:6px !important; padding-top:6px !important;' >";
				}
