        ...
        <div class="row">
          ...
          <div class="col-xs-6">
            ...
            <section class="panel">
              ...
              <section class="panel">
                <form action="<?=$_base['objeto']?>salvar_pedido/codigo/<?=$data->sessao?>" method="post" >
                        ...
                        <div class="form-group" >
                          ...
                          <div class="col-md-12">
                            <select data-plugin-selectTwo class="form-control" name="status" >
                              <option value='0' <?php if($data->status == 0){ echo "selected"; } ?> >Aguardando</option>
                              <option value='1' <?php if($data->status == 1){ echo "selected"; } ?> >Finalizado</option>
                            </select>
                          </div>
                        </div>
                ...
                <div class="panel-body">
                  ...
                  <fieldset>
                    ...
                    <div class="form-group" >
                      ...
                      <div class="col-md-12">
                        <input type="text" class="form-control" name="nome" value="<?=$data_cadastro->nome?>" >
                      </div>
                    </div>
                    ...
                    <div class="form-group" >
                      ...
                      <div class="col-md-12">
                        <input type="text" class="form-control" name="email" value="<?=$data_cadastro->email?>" >
                      </div>
                    </div>
                    ...
                    <div class="form-group" >
                      ...
                      <div class="col-md-12">
                        <input type="text" class="form-control" name="fone" value="<?=$data_cadastro->fone?>" >
                      </div>
                    </div>
                    ...
                    <div class="form-group" >
                      ...
                      <div class="col-md-12">
                        <input type="text" class="form-control" name="celular" value="<?=$data_cadastro->celular?>" >
                      </div>
                    </div>
                    ...
                    <div class="form-group" >
                      ...
                      <div class="col-md-12">
                        <input type="text" class="form-control" value="<?=$data_cadastro->complemento?>">
                      </div>
                    </div>

                    <div class="form-group" >
                      <label class="col-md-12" >Próximo de:</label>
                      <div class="col-md-12">
                        <input type="text" class="form-control" value="<?=$data_cadastro->referencia?>">
                      </div>
                    </div>
                    ...
                    <div class="form-group" >
                      ...
                      <div class="col-md-12">
                        <input type="text" class="form-control" value="<?=$data_cadastro->cidade?> - <?=$data_cadastro->estado?>">
                      </div>
                    </div> 
