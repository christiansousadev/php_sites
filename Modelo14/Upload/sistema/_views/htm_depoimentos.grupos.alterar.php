...
<form action="<?=$_base['objeto']?>grupos_alterar_grv" class="form-horizontal" method="post" >
	...
	<fieldset>
		...
		<div class="form-group">
			<label class="col-md-12" >Estilo do botão Enviar</label>
			<div class="col-md-12">
		...
		<div class="form-group">
			<label class="col-md-12" >Estilo do botão Enviar Dep.</label>
			<div class="col-md-12">
				<select name="botao_codigo_env_dep" class="form-control select2" style="width: 100%;" > 
					<?php
					foreach ($botoes as $key => $value) {

						if($data->botao_codigo_env_dep == $value['codigo']){ $selected = " selected='' "; } else { $selected = ""; }
