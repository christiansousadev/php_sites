...
<section id="section-postagens-<?=$conteudo_id?>" class="animate-effect" style="padding-top:40px; padding-bottom:10px; background-color: <?=$cores[46]?>; ">
	<div class="container">
			...
			<div class='row' >
				<div class='col-xs-12 col-sm-12 col-md-12' >
					<div>
						...
						<div class="titulo_padrao_linha" style="color:<?=$cores[47]?>; " ><i class="fas fa-caret-down"></i></div> 
					</div>
				</div>
			</div>
